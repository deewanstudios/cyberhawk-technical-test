                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="text-lg leading-7 font-semibold">
                            <p class="underline text-gray-900 dark:text-white">Inspections</p>

                            <ul>
                                @foreach ($inspections as $turbineInspection)
                                @foreach ($turbineInspection->inspections as $inspection)
                                <li>
                                    <a href="{{$item->id}}/inspections/{{$inspection->id}}"
                                        class="underline text-gray-900 dark:text-white">{{date('Y-m-d',strtotime($inspection->inspection_date))}}</a>
                                    <span>Grade: {{$inspection->grade}}</span>
                                </li>
                                @endforeach
